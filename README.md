...
# test codecov linux py39-test

![test codecov linux py39-test banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        ...
        <a href="https://github.com/whiteprints-tests/test-codecov-linux-py39-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-codecov-linux-py39-test.svg?logo=GitHub"></a>
        ...
        <a href="https://codecov.io/gh/whiteprints-tests/test-codecov-linux-py39-test" ><img alt="codecov badge" src="https://codecov.io/gh/whiteprints-tests/test-codecov-linux-py39-test/graph/badge.svg?token="/></a>
    </p>
</div>
